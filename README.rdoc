...
From the mustache_i18n_rails directory:
+rake install+

_or_

From github:
+gem install mustache_i18n_rails+

_or_

Add +mustache_i18n_rails+ to your Gemfile, then:
+bundle install+
...
1. The full key must be provided as a String.  Keys are nested under a global namespace defined by +Mustache::I18n.translation_root_key+ (default is +javascript+).
