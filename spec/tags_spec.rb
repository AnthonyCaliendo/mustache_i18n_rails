...
describe Mustache::I18n do
  ...
  it 'renders simple key correctly' do
    I18n.should_receive(:translate).with('javascript.pies.show.pie_flavor', {}).and_return 'success'
    Mustache.render_file('simple_key', {}).should == 'success'
  end

  it 'renders key with arguments correctly' do
    I18n.should_receive(:translate).with('javascript.pies.show.remaining_pieces', {'count' => 7}).and_return 'success'
